...
public class CentroDeAyudaPage {
    ...
    public static final Target RESULTADOS_BUSQUEDA = Target.the("Resultados de la búsqueda")
            .located(By.xpath("//div[contains(@class, 'p1ufbpnp') and text()='Resultados de la búsqueda']"));
}